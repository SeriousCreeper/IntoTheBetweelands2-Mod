package com.seriouscreeper.bladditions.crafttweaker;
...
@ZenRegister
@ZenClass(EmberBoreFixed.CLASS)
public class EmberBoreFixed {
    public static final String CLASS = "mods.embers.EmberBoreFixed";
    ...
    public EmberBoreFixed(BoreOutput internal) {
        this.internal = internal;
    }

    @ZenMethod
    public static EmberBoreFixed create(Integer[] dimensions, String[] biomes) {
        EmberBoreFixed emberBore = new EmberBoreFixed(new BoreOutput());
        emberBore.setDimensions(dimensions);
        emberBore.setBiomes(biomes);
        RecipeRegistry.registerBoreOutput(emberBore.internal);
        return emberBore;
    }

    @ZenMethod
    public static EmberBoreFixed getDefault() {
        return new EmberBoreFixed(RecipeRegistry.defaultBoreOutput);
    }
}