...
public final class FairyLightsRecipes {
    ...
    private static IRecipe createFairyLights() {
        return new GenericRecipeBuilder(FLItems.HANGING_LIGHTS)
                .withShape("I-I")
                .withIngredient('I', "ingotSyrmorite")
                .withAnyIngredient('-',
                        new IngredientRegularBasic(ItemMisc.EnumItemMisc.SWAMP_REED_ROPE.create(1)) {
                            @Override
                            public ImmutableList<ImmutableList<ItemStack>> getInput(ItemStack output) {
                ...
                .withAuxiliaryIngredient(new IngredientAuxiliaryBasicInert(BlockRegistry.WISP, false, 1) {
                    @Override
                    public ImmutableList<ImmutableList<ItemStack>> getInput(ItemStack output) {
    ...
    private static IRecipe createFairyLightsAugmentation() {
        return new GenericRecipeBuilder(FLItems.HANGING_LIGHTS)
                ...
                .withAuxiliaryIngredient(new IngredientAuxiliaryListInert(true,
                        ...
                        new IngredientAuxiliaryBasic<MutableInt>(BlockRegistry.WISP, false, 1) {
                            @Override
    ...
    private static IRecipe createTinselGarland() {
        return new GenericRecipeBuilder(FLItems.TINSEL)
                .withShape(" P ", "I-I", " D ")
                .withIngredient('P', ItemMisc.EnumItemMisc.PARCHMENT.create(1))
                .withIngredient('I', "ingotSyrmorite")
                .withIngredient('-', ItemMisc.EnumItemMisc.SWAMP_REED_ROPE.create(1))
