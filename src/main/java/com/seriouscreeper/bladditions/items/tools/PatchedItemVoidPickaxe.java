...
public class PatchedItemVoidPickaxe extends ItemPickaxe implements IWarpingGear, IThaumcraftItems, ICorrodible {
    public PatchedItemVoidPickaxe(ToolMaterial enumtoolmaterial) {
        super(enumtoolmaterial);
        this.setCreativeTab(ConfigItems.TABTC);
        this.setRegistryName("thaumcraft:void_pick");
        this.setTranslationKey("void_pick");
