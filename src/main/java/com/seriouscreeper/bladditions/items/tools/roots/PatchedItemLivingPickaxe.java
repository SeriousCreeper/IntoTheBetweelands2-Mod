...
public class PatchedItemLivingPickaxe extends ItemLivingPickaxe implements ICorrodible {
    public PatchedItemLivingPickaxe(ToolMaterial material, String name) {
        super(material, name);
