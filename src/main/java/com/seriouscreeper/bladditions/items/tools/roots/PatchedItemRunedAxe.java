...
import epicsquid.roots.item.runed.ItemRunedAxe;
...
public class PatchedItemRunedAxe extends ItemRunedAxe implements ICorrodible {
    public PatchedItemRunedAxe(ToolMaterial material, String name) {
        super(material, name);
