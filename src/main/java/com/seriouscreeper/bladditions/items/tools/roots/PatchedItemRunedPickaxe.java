...
import epicsquid.roots.item.runed.ItemRunedPickaxe;
...
public class PatchedItemRunedPickaxe extends ItemRunedPickaxe implements ICorrodible {
    public PatchedItemRunedPickaxe(ToolMaterial material, String name) {
        super(material, name);
