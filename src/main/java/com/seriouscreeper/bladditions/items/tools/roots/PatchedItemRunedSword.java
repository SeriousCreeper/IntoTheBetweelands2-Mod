...
import epicsquid.roots.item.runed.ItemRunedSword;
...
public class PatchedItemRunedSword extends ItemRunedSword implements ICorrodible {
    public PatchedItemRunedSword(ToolMaterial material, String name) {
        super(material, name);
