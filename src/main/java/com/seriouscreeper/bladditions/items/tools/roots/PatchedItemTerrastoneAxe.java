...
import epicsquid.roots.item.terrastone.ItemTerrastoneAxe;
...
public class PatchedItemTerrastoneAxe extends ItemTerrastoneAxe implements ICorrodible {
    public PatchedItemTerrastoneAxe(ToolMaterial material, String name) {
        super(material, name);
