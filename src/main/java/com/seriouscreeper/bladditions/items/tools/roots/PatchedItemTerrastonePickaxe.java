...
import epicsquid.roots.item.terrastone.ItemTerrastonePickaxe;
...
public class PatchedItemTerrastonePickaxe extends ItemTerrastonePickaxe implements ICorrodible {
    public PatchedItemTerrastonePickaxe(ToolMaterial material, String name) {
        super(material, name);
