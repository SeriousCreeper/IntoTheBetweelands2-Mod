...
import epicsquid.roots.item.terrastone.ItemTerrastoneSword;
...
public class PatchedItemTerrastoneSword extends ItemTerrastoneSword implements ICorrodible {
    public PatchedItemTerrastoneSword(ToolMaterial material, String name) {
        super(material, name);
